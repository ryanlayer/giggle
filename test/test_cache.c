...
void test_simple_cache(void)
{
    ...
    simple_cache_add(1, 0, t, &tripple_cache_handler);
    ...
    simple_cache_add(0, 0, t, &tripple_cache_handler);
    ...
    simple_cache_add(0, 1, t, &tripple_cache_handler);
    ...
    simple_cache_add(0, 2, t, &tripple_cache_handler);
...
void test_simple_cache_as_cache_with_new_disk_order(void)
{
    ...
    cache.add(1, 0, t, &tripple_cache_handler);
    ...
    cache.add(0, 0, t, &tripple_cache_handler);
    ...
    cache.add(0, 1, t, &tripple_cache_handler);
    ...
    cache.add(0, 2, t, &tripple_cache_handler);
    //}}}
