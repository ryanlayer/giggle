...
from cStringIO import StringIO # python3: use io module instead


# todo:
'''
    - I am missing many giggle flags like -s
    - -m (metadata) flag is untested, but should work
    - parallelization seems to be speeding up as expected, but only by a small factor- more data needed
    - impl search
'''
